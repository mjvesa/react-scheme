...
if( typeof(BiwaScheme)!='object' ) BiwaScheme={}; with(BiwaScheme) {
  ...
  BiwaScheme.js_closure2 = function(proc, intp){
    var intp2 = new Interpreter(intp);
    return function(/*args*/){
      arguments.self = this;
      var poks = _.toArray(arguments);
      poks.push(this);
      return intp2.invoke_closure(proc, poks);
    };
  };
  ...
  define_libfunc("js-closure2", 1, 1, function(ar, intp){
    assert_closure(ar[0]);
    return BiwaScheme.js_closure2(ar[0], intp);
  });
